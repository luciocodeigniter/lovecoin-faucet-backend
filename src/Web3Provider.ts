...
const web3Instance = new Web3(
    ...
    // Para realizar as operações na blockchain
    `${process.env.NODE_URL}`
);

// Cria a conta a partir da chave privada para se conectar à blockchain
...
// isso garante que todas as chamas serão do owner
web3Instance.eth.accounts.wallet.add(account);
